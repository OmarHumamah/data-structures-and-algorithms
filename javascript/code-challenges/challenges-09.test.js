...
const hasChildrenValues = (arr, character) => {
  ...
  let newArray = arr.find((i)=>{
    return i.name === character 
  })
  return Object.values(newArray).length > 3 ? true : false 
  //return arr.forEach(house=>{
  //  Object.values(house.children).includes(character) ? true : false })
